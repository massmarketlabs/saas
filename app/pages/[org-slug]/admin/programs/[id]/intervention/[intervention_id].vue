...
import type { beneficiary_intervention_enrollment, evaluation, interventions, programs, terms } from '~~/server/database/schema'

type DataKey = 'evaluation' | 'programs' | 'terms' | 'beneficiary_intervention_enrollment'
  ...
  <NuxtLayout name="admin">
    ...
    >
      ...
      <UCard>
        ...
        <pre>{{ data?.data.beneficiary_intervention_enrollment }}</pre>
      </UCard>
      <!-- Terms -->
      <!-- <UCard>
        <template #header>
