...
interface ModelAddBeneficiaryToInterventionProps {
  enlistedBeneficiaries: string[]
}

const props = defineProps<ModelAddBeneficiaryToInterventionProps>()
const emits = defineEmits(['enrollmentChange'])
...
const roleFilter: FilterCondition = { col: 'role', op: 'comma-separated', v: 'beneficiary' }
...
const handleUpdateEnlistedBeneficiary = async (enroll: boolean | string, user_id: string) => {
